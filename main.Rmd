...
对于$\pi_{vag}(\beta,\sigma^2)$的选取，由于涉及联合先验，此处可选择弱信息共轭先验，例如$\pi_{vag}(\beta,\sigma^2)=N(\hat\beta_{hst},n\sigma^2(X_{hst}^TX_{hst})^{-1})\cdot$$InvGamma(\frac{1}{2}, \frac{RSS_{hst}}{2})$，形式上可解释为unit information prior。
